"""Convert Rapid Ingress PF-TH-A into Battle Companion layout JS (Unstoppable Force)."""
...
OUT = ROOT / "app" / "js" / "battleSim" / "layoutData" / "unstoppableForce.js"
LAYOUT_ID = "PF-TH-A"
...
def main() -> None:
    ...
    layout = {
        ...
        "page": 3,
        "source": "Rapid Ingress PF-TH-A (Purge the Foe vs Take and Hold Layout A)",
    ...
    OUT.write_text(
        ...
        f"export const UNSTOPPABLE_FORCE_LAYOUT = {body};\n",
        encoding="utf-8",
    )
    print(
        "wrote",
