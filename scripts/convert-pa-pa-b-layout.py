"""Convert Rapid Ingress PA-PA-B into Battle Companion layout JS (Priority Assets vs Priority Assets Layout B)."""
...
SRC = (
    ROOT
    / "Priority Assets vs Priority Assets Layout B - 40k 11th Edition Deployment Map_files"
    / "terrain-data-11e.js.download"
)
OUT = ROOT / "app" / "js" / "battleSim" / "layoutData" / "priorityAssetsVsPriorityAssetsB.js"
LAYOUT_ID = "PA-PA-B"
...
def main() -> None:
    ...
    layout = {
        "id": "priority-assets-b",
        "name": "Priority Assets vs Priority Assets Layout B",
        "page": 4,
        "source": "Rapid Ingress PA-PA-B (Priority Assets vs Priority Assets Layout B)",
    ...
    OUT.write_text(
        "/** Auto-generated from Rapid Ingress PA-PA-B — do not hand-edit polygons. */\n"
        f"export const PRIORITY_ASSETS_VS_PRIORITY_ASSETS_B_LAYOUT = {body};\n",
        encoding="utf-8",
    )
    print(
        "wrote",
