"""Convert Rapid Ingress PF-PF-B into Battle Companion layout JS (Meatgrinder 1)."""
...
SRC = (
    ROOT
    / "Purge the Foe vs Purge the Foe - Layout B _ Warhammer 40k Terrain Layout _ Rapid Ingress_files"
...
OUT = ROOT / "app" / "js" / "battleSim" / "layoutData" / "meatgrinder1.js"
LAYOUT_ID = "PF-PF-B"
...
def main() -> None:
    ...
    layout = {
        ...
        "name": "Meatgrinder 1",
        "page": 2,
        "source": "Rapid Ingress PF-PF-B (Purge the Foe vs Purge the Foe Layout B)",
    ...
    OUT.write_text(
        ...
        f"export const MEATGRINDER_1_LAYOUT = {body};\n",
        encoding="utf-8",
    )
    print(
        "wrote",
